...
export default function AddWriters() {
  ...
  //   const publishedBooks = form.publishedBooks.value
  //   const image = ''
  ...
  //   const writerObj = {
  //     name, description, image, published_books,
  //   }
  //   console.log(writerObj);

  //     // send data to database
  //   fetch('https://bookapp-backend-ylwm.onrender.com/upload-writer', {
  //     method: "POST",
  //     headers: {
  //       "Content-type": "application/json",
  //     },
  //     body: JSON.stringify(writerObj)
  //   })
  //   .then(res => res.json())
  //   .then(data => {
  //     console.log(data)
  ...
  return (
    <div className='px-4 my-12 hidden sm:block md:flex justify-center'>
      ...
      <form className='md:w-3000 mx-10' onSubmit={handleSubmit(onSubmit)}>
        <div>
          <h2 className='mb-8 text-3xl font-semibold '>Add a writer</h2>
        </div>
